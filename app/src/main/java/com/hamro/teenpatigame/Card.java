...
public class Card {
    ...
    private static final int CLUBS = 1;//chidi
    private static final int DIAMONDS = 2;//itta
    private static final int HEARTS = 3;//pana
    private static final int SPADES = 4;//bhote
